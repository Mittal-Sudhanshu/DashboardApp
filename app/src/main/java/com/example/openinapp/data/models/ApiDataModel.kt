package com.example.openinapp.data.models
...
data class Data(
    ...
    @SerializedName("top_links") val topLinks: ArrayList<TopLink>,
    @SerializedName("favourite_links") val favouriteLinks: List<Any>, // Change the type accordingly
...
data class RecentLink(
    ...
    @SerializedName("thumbnail") val thumbnail: Any, // Change the type accordingly
    @SerializedName("times_ago") val timesAgo: String,
    @SerializedName("created_at") val createdAt: String,
    @SerializedName("domain_id") val domainId: String,
    @SerializedName("url_prefix") val urlPrefix: Any, // Change the type accordingly
